...
namespace LrphptTest\DoctrineHydrationModule;
...
class Bootstrap
{
    ...
    {
        $this->autoLoader->addPsr4('LrphptTest\\DoctrineHydrationModule\\Tests\\', __DIR__.'/Tests/');
        $this->autoLoader->addPsr4('LrphptTest\\DoctrineHydrationModule\\Fixtures\\', __DIR__.'/Fixtures/');
