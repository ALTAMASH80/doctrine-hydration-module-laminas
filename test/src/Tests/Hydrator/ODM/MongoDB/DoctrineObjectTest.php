...
namespace LrphptTest\DoctrineHydrationModule\Tests\Hydrator\ODM\MongoDB;

use Doctrine\ODM\MongoDB\Tests\BaseTest;
use Lrphpt\DoctrineHydrationModule\Hydrator\ODM\MongoDB\DoctrineObject;
use LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationEmbedMany;
use LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationEmbedOne;
use LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationReferenceMany;
use LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationReferenceOne;
use LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationUser;
...
class DoctrineObjectTest extends BaseTest
{
    ...
    public function it_should_be_initializable()
    {
        ...
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Hydrator\ODM\MongoDB\DoctrineObject', $hydrator);
    }
    ...
    public function it_should_hydrate_a_document()
    {
        ...
        $this->assertInstanceOf('LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationReferenceOne', $user->getReferenceOne());
        $referenceMany = $user->getReferenceMany();
        $this->assertInstanceOf('LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationReferenceMany', $referenceMany[0]);
        $this->assertInstanceOf('LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationEmbedOne', $user->getEmbedOne());
        $embedMany = $user->getEmbedMany();
        $this->assertInstanceOf('LrphptTest\DoctrineHydrationModule\Fixtures\ODM\MongoDb\HydrationEmbedMany', $embedMany[0]);
