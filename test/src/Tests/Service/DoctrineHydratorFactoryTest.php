...
namespace LrphptTest\DoctrineHydrationModule\Tests\Service;

use LrphptTest\DoctrineHydrationModule\Hydrator\CustomBuildHydratorFactory;
use Lrphpt\DoctrineHydrationModule\Service\DoctrineHydratorFactory;
...
class DoctrineHydratorFactoryTest extends TestCase
{
    ...
    /**
     * @return \Lrphpt\DoctrineHydrationModule\Hydrator\DoctrineHydrator
     */
    ...
    {
        $factory = new DoctrineHydratorFactory();
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Service\DoctrineHydratorFactory', $factory);
    }
    ...
    public function it_should_create_a_custom_ORM_hydrator()
    {
        ...
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Hydrator\DoctrineHydrator', $hydrator);
    ...
    public function it_should_create_a_custom_ODM_hydrator()
    {
        ...
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Hydrator\DoctrineHydrator', $hydrator);
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Hydrator\ODM\MongoDB\DoctrineObject', $hydrator->getExtractService());
        $this->assertInstanceOf('Lrphpt\DoctrineHydrationModule\Hydrator\ODM\MongoDB\DoctrineObject', $hydrator->getHydrateService());
    }
